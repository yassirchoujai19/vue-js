...
This project demonstrates core Vue concepts such as ref, reactive, v-if, v-for, v-on, v-bind, v-model, emit, watch, and lifecycle hooks (onMounted, onUpdated).
...
Building a clean, component-based UI structure
